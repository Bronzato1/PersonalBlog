...
namespace PersonalBlog.Quizbee.Helpers
{
    public static class URLHelper
    {
        public static string Home(this IUrlHelper helper, string searchTerm = "", int? pageNo = 1, int? pageSize = 10)
        {
        ...
        public static string QuizzesList(this IUrlHelper helper, string searchTerm = "", int? pageNo = 1, int? pageSize = 10)
        {
            string routeURL = string.Empty;
        ...
        public static string NewQuiz(this IUrlHelper helper)
        {
            string routeURL = string.Empty;
        ...
        public static string AttemptQuiz(this IUrlHelper helper, int quizID)
        {
            string routeURL = string.Empty;
